(function () {
  window.buildFrontendToc = function buildFrontendToc() {
    document.querySelectorAll('.frontend-toc').forEach((toc) => toc.remove());

    const content = document.querySelector('.post-single .post-content');
    if (!content || content.querySelector('.protected-post')) return;
