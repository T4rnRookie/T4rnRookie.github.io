---
title: "谈Express engine处理引擎的一个trick"
date: 2026-04-14
draft: false
tags: ["安全研究", "Web安全", "Node.js"]
summary: "分析 Express render 流程中引擎加载的一个有趣点，记录一种可用于 CTF 的利用思路"
---

> tips: 2024 年写，迁移自先知社区旧文
...
在这里函数 `__express` 被导入然后定义在 `opts.engines[this.ext]`，也就是说现在 engine 里有 `__express` 函数。

![](20240201163855-5603c7dc-c0dd-1.png)
...
![](20240201163903-5a61b29e-c0dd-1.png)
...
![](20240201163910-5eb1460c-c0dd-1.png)
...
如果我们有一个文件上传位点可控，能把文件夹传到 `node_modules` 下，其实就可以进行 `__express` 函数的使用了。
...
![](20240201163919-64586540-c0dd-1.png)

他的 engines 内容是我们键入的代码：

![](20240201163925-67f18862-c0dd-1.png)
